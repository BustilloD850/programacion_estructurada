...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-07-2025 a las 17:35:44
...
(1, 'mario bros', 'animada', 'a+', 'infantil', 'español'),
(2, 'toy story', 'animada', 'a+', 'infantil', 'español'),
(3, 'spiderman', 'accion', 'b+', 'animada', 'ingles'),
(4, 'pokemon', 'animada', 'a+', 'infantil', 'español'),
(5, 'minecraft', 'animada', 'a+', 'infantil', 'ingles');
